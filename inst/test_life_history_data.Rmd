...
>Run ccube with 10 clusters
```{r}
results <- foreach(n = 1:10, .combine = c) %dopar% {
  list(ccube_m6(mydata, epi=1e-3,
         init=10, tol = 1e-10, maxiter = 1e3,
...
hist(mydata$ccube_ccf, density=20, breaks=20, prob=TRUE,
     main = "estimated ccf histogram +
     ccf mean uncertainties (red)",
